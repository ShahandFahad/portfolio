...
// Background color combination to try
...
// beam: indigo-500 to purple-500

  return (
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-[40rem] bg-gradient-to-r from-black via-slate-900 to-black relative flex items-center w-full justify-center overflow-hidden",
